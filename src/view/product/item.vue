      ...
      <Tabs value="name1">
        <TabPane label="基本属性" name="name1">
                  ...
                  <Col span="16">
                    <table class="table">
                      ...
                      <tr v-for="(sku,i) in formData.skuList">
                        ...
                        <td class="center"><Input type="number" v-model="sku.marketPrice" /></td>
                        <td class="center"><Input type="number" v-model="sku.sellPrice" /></td>
                        <td class="center"><Input type="number" v-model="sku.costPrice" /></td>
          ...
          <Row :gutter="15">
              ...
              <Col span="2" class="form-label">选择供应商</Col>
              <Col span="4">
                <FormItem prop="supplierId">
                <SupplierSelect v-model="formData.supplierId" :supplier-id="formData.supplierId.toString()" />
                </FormItem>
              </Col>
