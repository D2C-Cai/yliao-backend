    ...
    <div class="login-wrap">
      ...
      <div class="login-form">
        <form @submit.prevent="login">
          <div class="item">
            <Input placeholder="请输入你的账号" size="large" v-model="username">
              <Icon slot="prefix" type="ios-contact"  />
            </Input>
          </div>
          <div class="item">
            <Input placeholder="请输入登录密码" size="large" type="password" v-model="password">
              <Icon slot="prefix" type="ios-lock" />
            </Input>
          </div>
...
<style lang="less">
  #login {
    ...
    right:0;
    bottom:0;
    background:url(https://s.yliao.com/img/mana_login_bg.jpg) center center no-repeat;
  ...
  .login-wrap {
    ...
    .login-banner {
      ...
      width:420px;
      height:400px;
      background:url(https://s.yliao.com/img/mana_login_banner.jpg) center center no-repeat;
      background-size: cover;
    }
    .login-form {
      border-bottom-right-radius:10px;
