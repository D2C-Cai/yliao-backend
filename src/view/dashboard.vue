  ...
  <div class="layout">
    <Layout>
      <Header class="layout-header">
        <div class="layout-logo">
          <div><a href="/"><img src="../assets/logo.png" /></a></div>
        </div>
      ...
      <Layout class="layout-content scrollbar" id="layout-wraper">
        ...
        <Content style="padding:2.5%;background:#FFF;box-shadow:0 0 5px rgba(0,0,0,0.07)">
          <keep-alive>
    ...
    <Modal v-model="modifyPasswordModalShow" :loading="saveLoading" width="400" title="修改密码" @on-ok="saveModifyPassword">
      <div style="margin-top:20px">
        <Form :model="formData" ref="formValidate" :rules="formValidate" :label-width="80" style="padding-right:5%">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      clearCache(){
        this.LocalStorage.removeItem('CATEGORY_LIST')
        this.LocalStorage.removeItem('CLEAN_CATEGORY')
...
<style lang="less">
  .layout{
    ...
    &-header {
      ...
      background: linear-gradient(45deg,#808695, #515a6e);
      .layout-logo{
        width:200px;
        div {
          width: 100px;
